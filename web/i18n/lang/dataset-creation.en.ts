const translation = {
  ...
  stepTwo: {
    ...
    recommend: 'Recommend',
    qualifiedTip: 'Call LLM\'s embedding interface for processing to provide higher accuracy when users query.',
  ...
  stepThree: {
    ...
    sideTipContent: 'After the document finishes indexing, the dataset can be integrated into the application as context, you can find the context setting in the prompt orchestration page. You can also create it as an independent LLM indexing plugin for release.',
