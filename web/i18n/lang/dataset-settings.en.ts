const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Describe what is in this data set. A detailed description allows AI to access the content of the data set in a timely manner. If empty, We will use the default hit strategy.',
    ...
    indexMethodHighQualityTip: 'Call LLM\'s embedding interface for processing to provide higher accuracy when users query.',
