const translation = {
  ...
  menus: {
    ...
    apps: 'Build Apps',
    plugins: 'Plugins',
    pluginsTips: 'Integrate third-party plugins.',
    datasets: 'Datasets',
  ...
  members: {
    ...
    invitationSentTip: 'Added, and they can sign in to access your team data.',
    ok: 'OK',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by us allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
